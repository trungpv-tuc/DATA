...
import org.onosproject.net.topology.TopologyCluster; // Added
...
public class ReactiveForwarding {
    ...
    //Create a new object ReativePackerProcessor from below defined class
    ...
    @Property(name = "matchDstMacOnly", boolValue = true,
    ...
    public void activate(ComponentContext context) {
        ...
        //Create an additional thread to collect traffic status of the network

        AdaptiveDetection adaptiveDetection = new AdaptiveDetection();
        Thread t1 = new Thread(adaptiveDetection);
        t1.start();
    ...
    private class ReactivePacketProcessor implements PacketProcessor {
        ...
        HashMap<String, String> Database_fwd = new HashMap<String, String>();
        ...
        public void process(PacketContext context) {
            ...
            if (inPkt.getEtherType() == Ethernet.TYPE_IPV4) {
                ...
                //log.info(" Source IP 1st: {}", ipv4Packet.getSourceAddress());
                //log.info(" Source IP 2nd: {}", ipv4Packet.toIPv4Address("192.168.0.2"));
                ...
                if (ipv4Protocol == IPv4.PROTOCOL_TCP) {
                    ...
                    //log.info("TCP packet: Port from {} to {}", tcpPacket.getSourcePort(), tcpPacket.getDestinationPort());
                }
                if (ipv4Protocol == IPv4.PROTOCOL_UDP) {
                    UDP udpPacket = (UDP) ipv4Packet.getPayload();
                    //log.info("UDP packet: Port from {} to {}", udpPacket.getSourcePort(), udpPacket.getDestinationPort());
                }
                if (ipv4Protocol == IPv4.PROTOCOL_ICMP) {
                    ICMP icmpPacket = (ICMP) ipv4Packet.getPayload();
                    //log.info("ICMP packet: Port from {} to {}", icmpPacket.getIcmpType(), icmpPacket.getIcmpCode());
                }

                //Update Switches maps
            ...
            //log.info("Source Device: {}", pkt.receivedFrom().deviceId().toString());
            //log.info("Destination Device: {}", dst.location().deviceId().toString());
    ...
    private class AdaptiveDetection implements Runnable {
        //private Thread t;
        //private String threadName;

        //AdaptiveDetection(String name){
            //threadName = name;
            //log.info(" Created an Adaptive Detection Agent: {}", threadName);
        //}
